...
3. 利用隐马尔科夫链\(HMM\)、最大熵\(ME\)、条件随机场\(CRF\)等统计模型进行识别，[命名实体识别调研](https://github.com/wx-chevalier/AIDL-Series/tree/dec769b6a532b26ba98ec2adb43128aa00023bc7/自然语言处理/语法语义分析/www.nilday.com/命名实体识别调研/README.md) 有各个模型的效果总结。
