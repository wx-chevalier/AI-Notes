...
sre.ColorPicker.prototype.hex=function(){var a=function(a){return"#"+sre.ColorPicker.toHex_(a.red)+sre.ColorPicker.toHex_(a.green)+sre.ColorPicker.toHex_(a.blue)};return{background:a(this.background),alphaback:this.background.alpha.toString(),foreground:a(this.foreground),alphafore:this.foreground.alpha.toString()}};sre.ColorPicker.toHex_=function(a){a=a.toString(16);return 1===a.length?"0"+a:a};sre.HighlighterInterface=function(){};sre.HighlighterInterface.prototype.highlight=function(a){};sre.HighlighterInterface.prototype.unhighlight=function(){};sre.HighlighterInterface.prototype.setColor=function(a){};sre.AbstractHighlighter=function(){this.currentHighlights_=[];this.color=null};sre.AbstractHighlighter.prototype.highlight=function(a){this.currentHighlights_.push(a.map(goog.bind(function(a){return this.highlightNode(a)},this)))};sre.AbstractHighlighter.prototype.unhighlight=function(){var a=this.currentHighlights_.pop();a&&a.forEach(goog.bind(function(a){return this.unhighlightNode(a)},this))};sre.AbstractHighlighter.prototype.setColor=function(a){this.color=a};
sre.AbstractHighlighter.prototype.colorString=function(){return this.color.rgba()};sre.SvgHighlighter=function(){sre.AbstractHighlighter.call(this)};goog.inherits(sre.SvgHighlighter,sre.AbstractHighlighter);
sre.SvgHighlighter.prototype.highlightNode=function(a){if("svg"===a.tagName){var b={node:a,background:a.style.backgroundColor,foreground:a.style.color};a.style.backgroundColor=this.colorString().background;a.style.color=this.colorString().foreground;return b}var c=a.getBBox(),b=document.createElementNS("http://www.w3.org/2000/svg","rect");b.setAttribute("x",c.x);b.setAttribute("y",c.y);b.setAttribute("width",c.width);b.setAttribute("height",c.height);(c=a.getAttribute("transform"))&&b.setAttribute("transform",
c);b.setAttribute("fill",this.colorString().background);a.parentNode.insertBefore(b,a);b={node:b,foreground:a.getAttribute("fill")};a.setAttribute("fill",this.colorString().foreground);return b};sre.SvgHighlighter.prototype.unhighlightNode=function(a){a.background?(a.node.style.backgroundColor=a.background,a.node.style.color=a.foreground):(a.node.nextSibling.setAttribute("fill",a.foreground),a.node.parentNode.removeChild(a.node))};sre.MmlHighlighter=function(){sre.AbstractHighlighter.call(this)};goog.inherits(sre.MmlHighlighter,sre.AbstractHighlighter);sre.MmlHighlighter.prototype.highlightNode=function(a){var b=document.createElementNS("http://www.w3.org/1998/Math/MathML","mstyle");b.setAttribute("mathbackground",this.colorString().background);b.setAttribute("mathcolor",this.colorString().foreground);a.parentNode.replaceChild(b,a);b.appendChild(a);return{node:b}};
sre.MmlHighlighter.prototype.unhighlightNode=function(a){a=a.node;a.parentNode.replaceChild(a.firstElementChild,a)};sre.MmlHighlighter.prototype.colorString=function(){return this.color.hex()};sre.CssHighlighter=function(){sre.AbstractHighlighter.call(this)};goog.inherits(sre.CssHighlighter,sre.AbstractHighlighter);sre.CssHighlighter.prototype.highlightNode=function(a){var b={node:a,background:a.style.backgroundColor,foreground:a.style.color},c=this.colorString();a.style.backgroundColor=c.background;a.style.color=c.foreground;return b};sre.CssHighlighter.prototype.unhighlightNode=function(a){a.node.style.backgroundColor=a.background;a.node.style.color=a.foreground};sre.HtmlHighlighter=function(){sre.CssHighlighter.call(this);this.mode=""};goog.inherits(sre.HtmlHighlighter,sre.CssHighlighter);sre.HtmlHighlighter.prototype.setMode=function(a){this.mode=a};
sre.HtmlHighlighter.prototype.highlightNode=function(a){if("walk"===this.mode||"MathJax_HitBox"!==a.className&&(!a.previousSibling||"MathJax_HitBox"!==a.previousSibling.className))return sre.HtmlHighlighter.superClass_.highlightNode.call(this,a);if("MathJax_HitBox"===a.className){var b=a;a=a.nextSibling}else b=a.previousSibling;var c={node:b,opacity:b.style.opacity,background:b.style.backgroundColor,foreground:a.style.color},d=this.color.rgb();b.style.backgroundColor=d.background;b.style.opacity=
d.alphaback;a.style.color=d.foreground;return c};sre.HtmlHighlighter.prototype.unhighlightNode=function(a){"MathJax_HitBox"!==a.node.className?sre.HtmlHighlighter.superClass_.unhighlightNode.call(this,a):(a.node.style.backgroundColor=a.background,a.node.style.opacity=a.opacity,a.node.nextSibling.style.color=a.foreground)};sre.HighlighterFactory={};sre.HighlighterFactory.highlighter=function(a,b,c){a=new sre.ColorPicker(a,b);b=sre.HighlighterFactory.highlighterMapping_["NativeMML"===c.renderer&&"Safari"===c.browser?"CommonHTML":c.renderer];if(!b)return null;b=new b;b.setColor(a);b.setMode&&b.setMode(c.mode);return b};sre.HighlighterFactory.highlighterMapping_={SVG:sre.SvgHighlighter,NativeMML:sre.MmlHighlighter,"HTML-CSS":sre.HtmlHighlighter,CommonHTML:sre.CssHighlighter};sre.SpeechRule=function(a,b,c,d){this.name=a;this.dynamicCstr=b;this.precondition=c;this.action=d};sre.SpeechRule.prototype.toString=function(){return this.name+" | "+sre.SpeechRule.stringifyCstr(this.dynamicCstr)+" | "+this.precondition.toString()+" ==> "+this.action.toString()};sre.SpeechRule.Type={NODE:"NODE",MULTI:"MULTI",TEXT:"TEXT",PERSONALITY:"PERSONALITY"};
...
sre.MathCompoundStore.prototype.addUnitRules=function(a){var b=a.names;b&&(a.names=b.map(function(a){return a+":unit"}));this.addFunctionRules(a)};sre.MathCompoundStore.prototype.lookupRule=function(a,b){var c=this.subStores_[a.textContent];if(c)return c.lookupRule(a,b)};
...
sre.SemanticTree.Node.prototype.mathmlTreeString_=function(){return this.mathmlTree?this.mathmlTree.toString():"EMPTY"};sre.Semantic={};sre.Semantic.Font=sre.SemanticAttr.Font;sre.Semantic.Role=sre.SemanticAttr.Role;sre.Semantic.Type=sre.SemanticAttr.Type;sre.Semantic.getTree=function(a){return(new sre.SemanticTree(a)).xml()};sre.Semantic.getTreeFromString=function(a){a=sre.DomUtil.parseInput(a);return new sre.SemanticTree(a)};sre.MathspeakUtil={};sre.MathspeakUtil.spaceoutText=function(a){return a.textContent.split("").join(" ")};sre.MathspeakUtil.spaceoutNumber=function(a){a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.Semantic.Type.NUMBER,g=e.match(/\W/)?sre.Semantic.Role.UNKNOWN:sre.Semantic.Role.PROTECTED;e=c.parseFromString("<"+f+' role="'+g+'">'+e+"</"+f+">");b.push(e.documentElement)}return b};
sre.MathspeakUtil.spaceoutIdentifier=function(a){if(!a.textContent.match(/[a-zA-Z]+/))return a.setAttribute("role",sre.Semantic.Role.PROTECTED),[a];a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.Semantic.Type.IDENTIFIER;e=c.parseFromString("<"+f+' role="'+sre.Semantic.Role.UNKNOWN+'">'+e+"</"+f+">");b.push(e.documentElement)}return b};
...
sre.AuditoryDescription.toSimpleString=function(a,b){var c=""===b?"":b||" ";sre.AuditoryDescription.preprocessDescriptionList_(a);return sre.BaseUtil.removeEmpty(a.map(function(a){return a.descriptionString()})).join(c)};
...
sre.SpeechRuleEngine.prototype.clearCache=function(){this.cache_={}};sre.SpeechRuleEngine.prototype.getCacheForNode_=function(a){if(!a||!a.getAttribute)return null;a=a.getAttribute("id");return"undefined"===a||""===a?null:this.getCache_(a)};sre.SpeechRuleEngine.prototype.getCache_=function(a){return this.cache_[a]};sre.SpeechRuleEngine.prototype.pushCache_=function(a,b){if(a.getAttribute){var c=a.getAttribute("id");c&&(this.cache_[c]=b)}};
...
"speech",TYPE:sre.EnrichMathml.ATTRIBUTE_PREFIX_+"type"};
sre.EnrichMathml.enrich=function(a,b){var c=sre.Engine.getInstance();c.style="default";c.domain="mathspeak";c.semantics=!0;sre.SpeechRuleEngine.getInstance().clearCache();sre.SpeechRuleEngine.getInstance().parameterize(sre.MathmlStore.getInstance());sre.SpeechRuleEngine.getInstance().dynamicCstr=sre.MathStore.createDynamicConstraint(c.domain,c.style);var d=a.cloneNode(!0);sre.EnrichMathml.walkTree(b.root);sre.Debugger.getInstance().generateOutput(function(){sre.EnrichMathml.formattedOutput(d,a,b,
!0)});return a};
...
sre.Engine.getInstance().mathmlSpeech&&sre.EnrichMathml.addSpeech(a,b)};sre.EnrichMathml.addSpeech=function(a,b){var c=sre.DomUtil.parseInput("<stree>"+b.toString()+"</stree>",sre.EnrichMathml.Error),c=sre.SpeechRuleEngine.getInstance().evaluateNode(c),c=sre.AuditoryDescription.toSimpleString(c);a.setAttribute(sre.EnrichMathml.Attribute.SPEECH,c)};
...
sre.EnrichMathml.formattedOutput=function(a,b,c,d){d=d||!1;sre.EnrichMathml.formattedOutput_(a,"Original MathML",d);sre.EnrichMathml.formattedOutput_(c,"Semantic Tree",d);sre.EnrichMathml.formattedOutput_(b,"Semantically enriched MathML",d)};sre.EnrichMathml.formattedOutput_=function(a,b,c){a=sre.SemanticTree.formatXml(a.toString());c?console.log(b+":\n```html\n"+sre.EnrichMathml.removeAttributePrefix(a)+"\n```\n"):console.log(a)};
...
a.join(","));return this.mml};sre.CaseEmbellished=function(a){sre.AbstractEnrichCase.call(this,a);this.ofenceMml=this.ofence=this.fencedMml=this.fenced=null;this.ofenceMap={};this.cfenceMml=this.cfence=null;this.cfenceMap={};this.parentCleanup=[]};goog.inherits(sre.CaseEmbellished,sre.AbstractEnrichCase);sre.CaseEmbellished.test=function(a){return a.mathmlTree&&null!==a.fencePointer};
sre.CaseEmbellished.prototype.getMathml=function(){this.getFenced_();this.fencedMml=sre.EnrichMathml.walkTree(this.fenced);this.getFencesMml_();return this.rewrite_()};sre.CaseEmbellished.prototype.getFenced_=function(){for(var a=this.semantic;a.type!==sre.SemanticAttr.Type.FENCED;)a=a.childNodes[0];this.fenced=a.childNodes[0];this.ofence=a.contentNodes[0];this.cfence=a.contentNodes[1];sre.CaseEmbellished.fencedMap_(this.ofence,this.ofenceMap);sre.CaseEmbellished.fencedMap_(this.cfence,this.cfenceMap)};
sre.CaseEmbellished.fencedMap_=function(a,b){b[a.id]=a.mathmlTree;a.embellished&&sre.CaseEmbellished.fencedMap_(a.childNodes[0],b)};
...
sre.System.prototype.setupEngine=function(a){var b=sre.Engine.getInstance();b.style=a.style||b.style;b.domain=a.domain||b.domain;b.semantics=!!a.semantics;void 0!==a.cache&&(b.withCache=!!a.cache);b.mode=a.mode||b.mode;sre.SpeechRuleEngine.getInstance().parameterize(sre.MathmlStore.getInstance());sre.SpeechRuleEngine.getInstance().dynamicCstr=sre.MathStore.createDynamicConstraint(b.domain,b.style)};
sre.System.prototype.processExpression=function(a){try{var b=sre.DomUtil.parseInput(a,sre.System.Error);sre.Engine.getInstance().semantics&&(b=this.getSemanticTree_(b));sre.Debugger.getInstance().generateOutput(goog.bind(function(){return b.toString()},this))}catch(c){return console.log("Parse Error: "+c.message),""}sre.SpeechRuleEngine.getInstance().clearCache();a=sre.SpeechRuleEngine.getInstance().evaluateNode(b);return sre.AuditoryDescription.toSimpleString(a)};
sre.System.prototype.getSemanticTree_=function(a){a=sre.Semantic.getTree(a);return sre.Engine.getInstance().mode===sre.Engine.Mode.HTTP?a.firstElementChild:sre.DomUtil.parseInput(a.toString(),sre.System.Error)};sre.System.prototype.processFile_=function(a){try{var b=sre.SystemExternal.fs.readFileSync(a,{encoding:"utf8"})}catch(c){throw new sre.System.Error("Can not open file: "+a);}return this.processExpression(b)};
sre.System.prototype.processFile=function(a,b){var c=this.processFile_(a);if(b)try{sre.SystemExternal.fs.writeFileSync(b,c)}catch(d){throw new sre.System.Error("Can not write to file: "+b);}else console.log(c)};sre.Focus=function(a){this.nodes_=a.nodes?a.nodes:[];this.primary_=a.primary?a.primary:null};sre.Focus.prototype.getNodes=function(){return this.nodes_};sre.Focus.prototype.getPrimary=function(){return this.primary_};sre.SpeechGeneratorInterface=function(){};sre.SpeechGeneratorInterface.prototype.getSpeech=function(a){};sre.SpeechGeneratorInterface.prototype.start=function(){};sre.SpeechGeneratorInterface.prototype.end=function(){};sre.EventUtil={};sre.EventUtil.KeyCode={RETURN:13,ENTER:13,ESC:27,SPACE:32,LEFT:37,UP:38,RIGHT:39,DOWN:40,TAB:9,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90};
